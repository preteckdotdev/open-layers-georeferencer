// if (!imageTransform) ol.transform = {};
let imageTransform = {} as any;

if (!imageTransform) imageTransform = {} as any;
...
imageTransform.Helmert = class {
  ...
  transform(xy: any) {
    var m = this.matrix;
    return [
      m[0] * xy[0] + m[1] * xy[1] + m[2],
      m[3] * xy[0] + m[4] * xy[1] + m[5],
    ];
  }
